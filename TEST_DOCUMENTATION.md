...
- document-scoped rule cooldowns, document-versioned rule snapshots, resumable scan sessions with cumulative time/job/continuation limits and chunk-local timeout yielding, global language/rule/style/target/ignore/span limits, and atomic per-rule budgets;
